 ...
 **************************************************************/
    ...
    /** Recursively sorts the objects in a range of locations in an array into
     ascending order.
     * @param a An array of Comparable objects.
...
/**************************************************************
 * ITERATIVE INSERTION SORT (PROVIDED FOR REFERENCE)
 **************************************************************/
/** Sorts the first n objects in an array into ascending order.
 * @param a An array of Comparable objects.
 * @param n An integer > 0.
...
*/
/** Iterative insertion sort of the objects in a range of locations in an
 ...
 * @param anEntry The entry to be inserted into the sorted portion of the
array.
 * @param a An array of Comparable objects.
