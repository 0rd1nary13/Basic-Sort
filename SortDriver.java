...
/**
 * This code was completedn by Better Call Stack team.
 */
public class SortDriver {
    public static void main(String args[]) {
        ...
        SortArrayInstrumented sortArray = new SortArrayInstrumented();
        ...
        System.out.println("How many trials should be performed?");
        ...
        for (int i = 0; i < trials; i++) {
            ...
            System.out.println("Number of comparisons: " + sortArray.getComparisons());
        }
    }
    ...
    /**
     * A displayable representation of an array of Objects where toString is applied on each object in the array
     *
